...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(messageBody: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            ...
            .setContentTitle("Human Benchmark")
    ...
    companion object {
        ...
        const val BROADCAST_NEW_NOTIFICATION = "ipca.humanbenchmark.trabalhocm2021.notification"
        const val NOTIFICATION_MESSAGE = "ipca.humanbenchmark.trabalhocm2021.notification.message"
    }
}